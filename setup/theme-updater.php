 ...
 * if a theme update is available, in order
 ...
 * 
 */
function upthemes_check_for_update($checked_data) {
...
// Hook upthemes_check_for_update() into pre_set_site_transient_update_themes
add_filter( 'pre_set_site_transient_update_themes', 'upthemes_check_for_update' );
